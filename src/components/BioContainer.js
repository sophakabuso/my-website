...
const BioContainer = () => {
  return (
    ...
    <div className={styles.bioContainer}>
      ...
      <p>In 2004, I studied for BSc (Computer Science and Physics) at UNITRA, now Walter Sisulu University in Mthatha. Due to unforeseen events I had to dropout after a year In 2008, Eskom offered me a bursary to study BEng (Electrical Engineering) at the University of Pretoria, which I studied for two years before  my studies were terminated. Motivated by my love for learning, in 2017, I registered for BSc (Computer Science and Applied Mathematics) with UNISA, which I am still currently studying in the 2nd year. In 2018, I registered for a Higher Certificate in Total Quality Management with UNISA. Up to date, I have worked in various industries, including Banking or Financial Services, Manufacturing & Engineering, Retail, Sales, etc. I have also been involved in numerous community activities in various structures, including political, recreation, religious, business, and policing forums, taking numerous leadership positions.</p>
